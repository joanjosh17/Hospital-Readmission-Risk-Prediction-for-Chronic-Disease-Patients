...
This project is intended strictly for educational, research, and demonstration purposes. The machine learning models and predictions generated by this project are not intended to provide medical diagnosis, treatment recommendations, or clinical decision-making.

The dataset used in this project consists of synthetic patient records and does not represent real patients or real-world clinical outcomes. Model performance demonstrated in this project should not be interpreted as evidence of clinical effectiveness or readiness for deployment in healthcare settings.

This project should not be used as a substitute for professional medical judgment, validated clinical decision-support systems, or appropriate clinical evaluation and validation.
